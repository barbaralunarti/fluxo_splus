...
for i in range(0, len(loaded_gal_sample)):
    ...
    query = f"""
    SELECT
    det.ID, det.RA, det.DEC, u.u_auto, j0378.J0378_auto, j0395.J0395_auto,
    j0410.J0410_auto, j0430.J0430_auto, g.g_auto, j0515.J0515_auto,
    r.r_auto, j0660.J0660_auto, i.i_auto, j0861.J0861_auto, z.z_auto,
    u.e_u_auto, j0378.e_J0378_auto, j0395.e_J0395_auto, j0410.e_J0410_auto,
    j0430.e_J0430_auto, g.e_g_auto, j0515.e_J0515_auto, r.e_r_auto,
    j0660.e_J0660_auto, i.e_i_auto, j0861.e_J0861_auto, z.e_z_auto
...
table_index = 30 # select the index of the table
select_table
...
colunas_y = ['u_auto', 'J0378_auto', 'J0395_auto', 'J0410_auto', 'J0430_auto', 'g_auto', 'J0515_auto', 'r_auto', 'J0660_auto', 'i_auto', 'J0861_auto', 'z_auto']
...
plt.title('AM 0034-351 - Distribution of the 12 filters')
plt.show()
...
obj_index = 46
select_table = loaded_list[obj_index]
eixo_x = np.array([0.3563, 0.377, 0.394, 0.4094, 0.4292, 0.4751, 0.5133, 0.6258, 0.6614, 0.7690, 0.8611, 0.8831])
...
plt.xlabel(r'$\lambda_{\mathrm{eff}}$ (µm)')
plt.ylabel(r'$F_{\lambda}$ (erg s$^{-1}$ cm$^{-2}$ $\AA^{-1}$)')
plt.title('HRG 35002 - Distribution of the 12 filters')
