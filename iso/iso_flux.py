...
loaded_gal_sample = pd.read_pickle('galaxies.pkl')
...
for i in range(0, len(loaded_gal_sample)):
    ...
    query = f"""
    SELECT
    det.ID, det.RA, det.DEC, u.u_iso, j0378.J0378_iso, j0395.J0395_iso,
    j0410.J0410_iso, j0430.J0430_iso, g.g_iso, j0515.J0515_iso,
    r.r_iso, j0660.J0660_iso, i.i_iso, j0861.J0861_iso, z.z_iso,
    u.e_u_iso, j0378.e_J0378_iso, j0395.e_J0395_iso, j0410.e_J0410_iso,
    j0430.e_J0430_iso, g.e_g_iso, j0515.e_J0515_iso, r.e_r_iso,
    j0660.e_J0660_iso, i.e_i_iso, j0861.e_J0861_iso, z.e_z_iso
...
table_index = 22 # select the index of the table
print(loaded_gal_sample['Object'][obj_index])
select_table
...
colunas_y = ['u_iso', 'J0378_iso', 'J0395_iso', 'J0410_iso', 'J0430_iso', 'g_iso', 'J0515_iso', 'r_iso', 'J0660_iso', 'i_iso', 'J0861_iso', 'z_iso']
